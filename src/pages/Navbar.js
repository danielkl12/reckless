        ...
        <header id="home">
                {isDesktop ? (
                    ...
                    <div>
                        <nav id="nav-wrap" className="hidden-mobile">
                            <ul id="nav" className="nav" style= {{listStyle: 'none', }}>
                            <li style={{fontSize: "17px"}}><a href="#about">About</a></li>
                            <li style={{fontSize: "17px"}}><a href="#footer">Contact</a></li>
                            <li style={{fontSize: "17px"}}><a href="#photos">Photos</a></li>
                            <li style={{fontSize: "17px"}}><a href="#music">Music</a></li>
                            <li style={{fontSize: "17px"}}><a href="#video">Video</a></li>
                            <li style={{fontSize: "17px"}}><a href="#event">Events</a></li>
                            </ul>
                        </nav>
