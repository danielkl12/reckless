                ...
                {isDesktop ? (
                    ...
                    <div>
                        <nav id="nav-wrap" className="navbar-mobile">
                            <ul id="nav" className="nav" style= {{listStyle: 'none', }}>
                            <li style={{fontSize: "18px"}}><a href="#about">About</a></li>
                            <li style={{fontSize: "18px"}}><a href="#footer">Contact</a></li>
                            {/* <li style={{fontSize: "14px"}}><a href="#photos">Photos</a></li> */}
                            <li style={{fontSize: "18px"}}><a href="#music">Music</a></li>
                            <li style={{fontSize: "18px"}}><a href="#video">Video</a></li>
                            <li style={{fontSize: "18px"}}><a href="#event">Events</a></li>
                            </ul>
                        </nav>
