...
<div className="row">
        ...
        <section id="card" className="cards">
                        ...
                        <iframe id="reckless-video" width="470" height="225" style={{marginRight:"5px", marginBottom:"10px"}} src="https://www.youtube.com/embed/AXSlcBu1lss" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen ></iframe>
                        </article>
                        
                        
                        <article className="card">
                        <iframe id="reckless-video" width="470" height="225" style={{marginLeft:"5px"}} src="https://www.youtube.com/embed/S2V_DGyjzGM" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                        </article>
